...
const Recipe = () => {
  ...
  return (
    ...
    className="max-w-md mx-auto my-8 p-8 bg-white shadow-lg rounded"
  >
    <div className="mb-4">
      <label
        htmlFor="title"
    ...
    <div className="mb-4">
      ...
      {/* Assuming `Select` is a custom component for selecting options */}
      <Select
        id="ingredients"
        name="ingredients"
        isMulti
        value={recipe.ingredients.map((ingredient) => ({
        ...
        className={`w-full ${
          validationErrors.ingredients ? "border-red-500" : "border-blue-300"
        } text-black rounded`}
      />
      <span className="text-red-500 text-xs italic">
